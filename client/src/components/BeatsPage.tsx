...
export default function BeatsPage (){
    ...
    useEffect(() => {
        fetch(`http://localhost:5000/beats?tier=${starCount}&selectedBpm=${selectedBpm}&selectedPrice=${selectedPrice}&selectedGenre=${selectedGenre}`)
            .then((res) => res.json())
            .then((data) => {
                setBeats(data);
                setLoading(false);
                ...
                <div className="mt-6 flex flex-wrap items-center gap-3">
                    ...
                    <div className="relative w-full sm:w-44">
                        ...
                        >
                            ...
                            <option value="80-90">100–110 BPM</option>
                            <option value="90-100">100–110 BPM</option>
